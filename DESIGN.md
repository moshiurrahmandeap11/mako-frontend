...
## Mission
Create implementation-ready, token-driven UI guidance for Zapier: Automate AI Workflows, Agents, and Apps that is optimized for consistency, accessibility, and fast delivery across marketing site.
...
- Include known page component density: links (396), buttons (136), lists (47), cards (14), inputs (9), navigation (8).
