    ...
    <div className="relative min-h-screen bg-white text-[#222325] flex flex-col overflow-hidden">
      <main className="relative z-10 flex-1 max-w-4xl mx-auto w-full px-6 pt-36 pb-20 space-y-8">
        <div className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#222325]">Terms of Service</h1>
        ...
        <div className="bg-white border border-[#E4E5E7] rounded-2xl p-8 space-y-6 text-sm text-[#404145] leading-relaxed shadow-sm">
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-[#222325]">1. Service Provision & Uptime SLA</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-[#222325]">2. Acceptable Use & Whitelisting</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-[#222325]">3. Billing & Cancellation</h2>
            <p>
              Subscriptions renew automatically on a monthly cycle via Polar.sh. Merchants may upgrade, downgrade, or cancel their subscription at any time directly through the billing console.
            </p>
          </section>
        </div>
      </main>
