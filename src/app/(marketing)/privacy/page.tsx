    ...
    <div className="relative min-h-screen bg-white text-[#222325] flex flex-col overflow-hidden">
      <main className="relative z-10 flex-1 max-w-4xl mx-auto w-full px-6 pt-36 pb-20 space-y-8">
        <div className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#222325]">Privacy Policy</h1>
          <p className="text-xs text-[#74767E]">Last updated: August 2026</p>
        </div>

        <div className="bg-white border border-[#E4E5E7] rounded-2xl p-8 space-y-6 text-sm text-[#404145] leading-relaxed shadow-sm">
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-[#222325]">1. Zero Video & Camera Feed Retention</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-[#222325]">2. Merchant Data Isolation</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-[#222325]">3. Third-Party Integrations & Security</h2>
            <p>
              Payment processing is handled securely by Polar.sh. Live emails are delivered via encrypted API triggers. All API traffic is protected with strict CORS preflight policies.
            </p>
          </section>
        </div>
      </main>
