...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans overflow-x-hidden">
      ...
      {/* Navigation Header - Animated Floating Pill */}
      <motion.header 
      ...
      >
        <div className="px-6 md:px-8 h-16 flex items-center justify-between">
          ...
          {/* Brand Logo matching the MAKO style in the reference image */}
          <Link href="/" className="flex items-center gap-3.5 group">
            <div className="relative w-9 h-9 rounded-full bg-gradient-to-tr from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/25 transition-transform duration-300 group-hover:scale-105">
              {/* Stylized circle logo */}
              <div className="w-5 h-5 rounded-full border-[3px] border-white border-t-transparent animate-spin-slow" />
          ...
          <nav className="hidden md:flex items-center gap-2 text-[11px] font-bold tracking-[0.15em] text-slate-400">
            <Link href="#features" className="hover:text-amber-500 hover:bg-slate-900/50 transition-all px-4 py-2 rounded-full uppercase">
              Features
            </Link>
            <Link href="#about" className="hover:text-amber-500 hover:bg-slate-900/50 transition-all px-4 py-2 rounded-full uppercase">
              Technology
            </Link>
            <Link href="#pricing" className="hover:text-amber-500 hover:bg-slate-900/50 transition-all px-4 py-2 rounded-full uppercase">
              Pricing
            </Link>
            <Link href="#contact" className="hover:text-amber-500 hover:bg-slate-900/50 transition-all px-4 py-2 rounded-full uppercase">
              Contact
            </Link>
          </nav>
          ...
          <div className="hidden sm:flex items-center gap-4">
            {isPending ? (
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="px-5 py-2.5 bg-transparent text-amber-500 hover:bg-amber-500 hover:text-slate-950 font-bold text-xs tracking-[0.12em] border border-amber-500/70 rounded transition-all duration-300"
                >
                  GET STARTED
                </Link>
              </>
